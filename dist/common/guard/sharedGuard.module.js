...
exports.SharedGuardModule = SharedGuardModule = __decorate([
    ...
    (0, common_1.Module)({
        ...
        providers: [abilities_guard_1.AbilitiesGuard, auth_guard_1.AuthGuard, auth_grpc_service_1.AuthGrpcService],
        exports: [abilities_guard_1.AbilitiesGuard, auth_guard_1.AuthGuard, auth_grpc_service_1.AuthGrpcService],
    })
], SharedGuardModule);
